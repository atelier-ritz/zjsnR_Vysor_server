...
myStepper1 = mh.getStepper(1)      #  motor port #1
myStepper2 = mh.getStepper(2)      #  motor port #2
myStepper1.setStepsPerRev = 200    # 200 steps/rev by default
myStepper2.setStepsPerRev = 200    # 200 steps/rev by default
myStepper1.setSpeed(60)          # RPM
myStepper2.setSpeed(60)          # RPM
